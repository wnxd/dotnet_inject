...
#define mono_profiler_set_events mono_profiler_set_events_impl
...
#define mono_set_pending_exception mono_set_pending_exception_impl
...
#define mono_jit_set_aot_only mono_jit_set_aot_only_impl
...
bool
mono_set_pending_exception_exists ();
